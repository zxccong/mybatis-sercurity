...
//    public static void build(String[] tables,String type) {
    public static void build(String[] tables) {
        ...
        gc.setOutputDir("E:/2020-project/mybatis-security/src/main/java");
//        try {
//            gc.setOutputDir(ResourceUtils.getURL("classpath:").getPath());
